...
| -------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SetOutput <path.ext>`                 | —                     | Add an output; repeatable. `.cast`, `.txt`, `.gif`, `.webp`, `.mp4` and `.svg`[^svg-fonts] are supported; WebP uses agg + ffmpeg losslessly, MP4 lossily[^mp4]                                                              |
...
- `agg` + `ffmpeg` 6.1+ (`libx264`) -> `MP4` output.
- `asg` -> `SVG` output.
...
| -------------------------------- | ------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SetFontSize <px>`               | GIF, WebP, MP4, SVG | `28`         | Rendered font size in pixels                                                                                                                                                                                                                             |
| `SetFontFamily <family>`         | GIF, WebP, MP4, SVG | renderer's   | Preferred text fonts[^svg-fonts]; if none are available, the renderer uses its defaults; Nerd Font and emoji fallbacks remain enabled; excludes `SetFontFamilyExact`                                                                                     |
| `SetFontFamilyExact <list>`      | GIF, WebP, MP4, SVG | renderer's   | Complete family list[^svg-fonts], bypassing all fallbacks; excludes `SetFontFamily` and `SetEmojiFontFamily`                                                                                                                                             |
| `SetEmojiFontFamily <list>`      | GIF, WebP, MP4, SVG | renderer's   | Families emoji are drawn with[^svg-fonts], replacing the renderer's own chain; excludes `SetFontFamilyExact`                                                                                                                                             |
| `SetFontDir <dir>`               | GIF, WebP, MP4      | —            | Additional font directory searched by the renderer, which must exist; repeatable                                                                                                                                                                         |
| `SetEngine <swash\|resvg>`       | GIF, WebP, MP4      | `swash`      | Frame rendering backend; `resvg` draws COLRv1 emoji in color                                                                                                                                                                                             |
| `SetLineHeight <multiplier>`     | GIF, WebP, MP4, SVG | `1.2`        | Line-height multiplier passed to the renderer                                                                                                                                                                                                            |
| `SetTheme <theme>`               | GIF, WebP, MP4, SVG | `dracula`    | Theme name[^themes] or custom palette passed to each requested renderer                                                                                                                                                                                  |
| `SetBoldIsBright <on\|off>`      | GIF, WebP, MP4      | `off`        | Draw bold text in the bright ANSI color, as most terminals do                                                                                                                                                                                            |
...
| `SetFramerate <fps>`             | GIF, WebP, MP4, SVG | `30`         | Maximum number of rendered frames per second                                                                                                                                                                                                             |
| `SetPlaybackSpeed <multiplier>`  | GIF, WebP, MP4, SVG | `1`          | Playback speed of the rendered animation                                                                                                                                                                                                                 |
...
[^mp4]: MP4 is the only lossy output: H.264 (High profile, `-crf 18 -preset
    ...
    The measurements behind every encoder setting: [ENCODING](ENCODING.md).
...
| `Render`                            | End the recording and write every requested output; GIF, WebP and MP4 share one temporary GIF render, deleted afterwards                                                                                                                                                                       |
